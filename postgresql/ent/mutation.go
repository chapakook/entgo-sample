...
func (m *AccountMutation) SetMoney(i int) {
	m.money = &i
	m.addmoney = nil
}

// Money returns the value of the "money" field in the mutation.
func (m *AccountMutation) Money() (r int, exists bool) {
	v := m.money
	if v == nil {
		return
	}
...
// OldMoney returns the old "money" field's value of the Account entity.
// If the Account object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AccountMutation) OldMoney(ctx context.Context) (v int, err error) {
...
func (m *AccountMutation) AddMoney(i int) {
	if m.addmoney != nil {
		*m.addmoney += i
	} else {
		m.addmoney = &i
...
func (m *AccountMutation) AddedMoney() (r int, exists bool) {
	v := m.addmoney
	if v == nil {
		return
	}
...
func (m *AccountMutation) ResetMoney() {
	m.money = nil
	m.addmoney = nil
}
...
func (m *AccountMutation) Fields() []string {
	...
	if m.money != nil {
		fields = append(fields, account.FieldMoney)
	}
	return fields
}
